...
**Architecture & State:**
`Clean Architecture` `MVVM` `Bloc` `Provider` `Riverpod`

**Backend & Integration:**
![Firebase](https://img.shields.io/badge/firebase-%23039BE5.svg?style=for-the-badge&logo=firebase) `REST APIs` `GraphQL` `Git` `CI/CD`

**AI-Augmented Workflow:**
*Leveraging AI for 30% faster delivery*
`Cursor` `GitHub Copilot` `Augment Code`
...
### 📫 Connect with Me
* [LinkedIn](https://www.linkedin.com/in/munasirpv/)
* [Email](mailto:munasirpv@gmail.com)
